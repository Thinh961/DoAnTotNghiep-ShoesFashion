...
namespace ShoesFashion.Controllers
{
    ...
    public class ProductDetailController : ControllerBase
    {
        ...
        //POST Method
        [HttpPost]
        public JsonResult Post(ProductDetail productDetail)
        {
            string query = @"insert into ProductDetail(Quantity, SizeId, ColorId, 
                                                           ProductId , PriceOld, PriceNew, Image) values 
                (
        ...
        //PUT Method
        [HttpPut]
        public JsonResult Put(ProductDetail productDetail)
        {
            string query = @"update dbo.ProductDetail set
